        ...
        {models.map((m, i) => (
          <article key={m.slug} className="bg-[#0c111b] p-5">
            ...
            <div className="mt-4 flex flex-col gap-2 font-mono text-[12px] sm:flex-row">
              <a href={`/models/${m.slug}`} className="border border-[#1c2534] rounded-full px-3 py-3 text-center font-bold uppercase tracking-wider text-white hover:border-[#ff4d00]">More details →</a>
